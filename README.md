...
Computer Engineer (BSc) from `Politecnico di Milano` — Italy's #1 university and 20th in the world for Engineering & Technology (QS World University Rankings by Subject 2026) — now pursuing an `MSc in Computer Science` at `SUPSI` in Lugano, to bridge academic foundations with hands-on industry practice and projects.
...
<div align="center">
  <img src="https://gh-stats.com/api/lucasciarinii?show_icons=true&theme=tokyonight&hide_border=true&count_private=true" alt="GitHub Stats" width="49%" />
</div>
...
[![Website](https://img.shields.io/badge/🌐_losciar.com-000000?style=for-the-badge)](https://losciar.com)
